	...
	$.ajax({
		...
		success: (a) => {
			$('[name="id"]').val(a.id),
				...
				$('[name="nama_produk"]').val(a.nama),
                $('[name="hrgAsli"]').val(a.harga_asli),
				$('[name="hrgGrosir"]').val(a.harga_grosir),
				$('[name="hrgBiasa"]').val(a.harga_biasa),
                $('[name="jmlGrosir"]').val(a.jml_grosir),
				$(".modal").modal("show"),
