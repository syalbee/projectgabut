        ...
        <div class="modal-body">
          <form id="form">
            ...
            <div class="form-group">
              ...
              <input type="number" min="0" class="form-control" placeholder="Harga Asli" name="hrgAsli" required>
            </div>
            <div class="form-group">
              <label>Harga Grosir</label>
              <input type="number" min="0" class="form-control" placeholder="Harga Grosir" name="hrgGrosir" required>
            </div>
            <div class="form-group">
              <label>Harga Biasa</label>
              <input type="number" min="0" class="form-control" placeholder="Harga Grosir" name="hrgBiasa" required>
            </div>
            <div class="form-group">
              <label>Jumlah Minimal Grosir</label>
              <input type="number" class="form-control" placeholder="Jumlah Minimal Grosir" name="jmlGrosir" required>
            </div>
